...
```{r DataProcess, results = TRUE,echo=TRUE}
...
``` {r Transform, results = TRUE, echo = TRUE}
...
```{r histogram, results = TRUE, include=TRUE}
...
```{r TimeSeries, results = TRUE, include=TRUE}
...
```{r Weekdays,results = TRUE, include=TRUE}
