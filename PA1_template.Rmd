...
```{r DataProcess, results = 'asis',echo=TRUE}
...
``` {r Transform, results = 'asis', echo = TRUE}
...
```{r histogram, fig.show = 'asis', results = 'asis', include=TRUE}
...
```{r TimeSeries,fig.show='asis', results = TRUE, include=TRUE}
...
```{r ImputedSummary, results = 'asis', fig.show = 'asis', include=TRUE}
...
```{r Weekdays,results = 'asis', fig.show='asis', include=TRUE}
